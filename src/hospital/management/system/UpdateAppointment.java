...
public class UpdateAppointment extends JFrame {
        ...
        JLabel text = new JLabel("CUSTOMIZE APPOINTMENT DETAILS");
        text.setBounds(560, 20, 400, 45);
        text.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 21));
        ...
        update.setBounds(80, 650, 100, 30);
